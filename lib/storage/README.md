# @exteranto/storage
[![Build Status](https://travis-ci.org/exteranto/storage.svg?branch=master)](https://travis-ci.org/exteranto/storage)

The Storage API Driver for the Exteranto Framework.
