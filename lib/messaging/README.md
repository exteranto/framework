# @exteranto/messaging
[![Build Status](https://travis-ci.org/exteranto/messaging.svg?branch=master)](https://travis-ci.org/exteranto/messaging)

The Messaging API Driver for the Exteranto Framework.
